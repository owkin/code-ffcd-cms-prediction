...
"""Masked Linear implementation used for GatedAttention module."""
...
class MaskedLinear(torch.nn.Linear):
    ...
    Example:
        ...
        >>> module = MaskedLinear(
        ...     in_features=128, out_features=1, mask_value="-inf"
        ... )  # With MaskedLinear
        >>> out = module(slide, mask)  # Padding now has the '-inf' value
        >>> correct_value = torch.sigmoid(
        ...     out
        ... )  # Value is not influenced by padding as sigmoid('-inf') = 0
